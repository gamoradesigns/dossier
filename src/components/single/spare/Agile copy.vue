<template>
 ...
 brand core values, visual assets from the colors, typography, logos, customer demographics, application design
 and more. 
                </div>
              </div>
            </div>
                      ...
                      <div class="colorSubDivRight">
                        <div class="color-array-intro-body">
                          <div class="color-array-intro-body-text">
                            ...
                            signature is a combination of the symbol itself
 ...
 create our logo.
                          ...
                          <div class="logo-single-div">
                            ...
                            <div class="logo-content-div">
                              ...
                              <div class="logo-body">
                                The all black version be used when the background
                                color is light.
                              </div>
                            </div>
                          </div>
 ...
 tailored fitness journey. As well as, hundreds of workout playlists to
                    ...
                    <div class="colorSubDiv">
                      ...
                      <div class="colorSubDivRight">
                        <div class="color-array-intro-body">
                          <div class="color-array-intro-body-text">
                            Take a look! <br />
                      Sneak a peak at our tailored guidelines. Agile's Brand Manual lays out the brand and
 the approved visual elements, colors, typography, as well as the brand 
