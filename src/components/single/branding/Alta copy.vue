<template>
          ...
          <div class="container">
            <div class="agileBrand" v-if="grid">
              <div class="brandGridHomeDiv">
                ...
                Welcome and explore ALTAs brand basics and visual elements. Explore the
 ...
 reference.
                            ...
                            <div class="logo-single-div">
                              ...
                              <div class="logo-content-div">
                                ...
                                <div class="logo-body">
                                  Will be used when the background color is dark.
                                </div>
                              </div>
                            </div>
                            <div class="logo-single-div">
                      ...
                      <div class="colorSubDivRight">
                        <div class="color-array-intro-body">
                          <div class="color-array-intro-body-text">
                            ...
                            <br />
                     This color palette has been designed to convey
 the stability of banking with ALTA. Choosing to stick with a tight blue and green color palette,
 we give you our Peacock Color Palette
 ...
 Our Social Media Kit was designed with customizable, reusable and versatile 
 templates. To establish a consistence voice, tone and brand across all platforms.
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="colorSubDiv">
                      ...
                      <div class="colorSubDivRight">
                        <div class="color-array-intro-body">
                          <div class="color-array-intro-body-text">
                         Take a look! <br />
                      Sneak a peak at our tailored guidelines. ALTA's Brand Manual lays out the brand and
