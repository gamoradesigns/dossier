...
export default {
  ...
  data() {
    return {
      ...
      itemSelected: false,
      jarImgAssets2: [
          "bag5.jpg", "bag2.jpg", "bag4.jpg", "bag1.jpg"
      ],
      jarImgAssets: [
        {imgName : "bag5.jpg", currentEdition: "alpha"},
        {imgName : "bag2.jpg", currentEdition: "Omega"},
        {imgName : "bag4.jpg", currentEdition: "gamma"},
        {imgName : "bag1.jpg", currentEdition: "zeta"},
